...
链接：https://blog.csdn.net/qq_19934363/article/details/94170513

停用 idea 自带的 [markdown support](https://plugins.jetbrains.com/plugin/7793-markdown/)插件  （这个插件的评分非常低）
安装第三方插件 [markdown navigation](https://plugins.jetbrains.com/plugin/7896-markdown-navigator/)



## 8.集成java p字节码分析命令

https://blog.csdn.net/new1111111/article/details/79666454