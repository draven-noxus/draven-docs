...
yum install -y kubelet-1.17.0 kubeadm-1.17.0 kubectl-1.17.0 kubernetes-cni
...
# 6.2注意版本 注意网段
kubeadm init --kubernetes-version=1.17.0 --pod-network-cidr=10.244.0.0/16
#  看到以下信息表示安装成功
见 初始化k8s
...
NAME         STATUS   ROLES    AGE     VERSION
k8s-master   Ready    master   6m20s   v1.17.4
...
# 初始化（不建议）
kubeadm init  --kubernetes-version=1.17.0  --pod-network-cidr=10.8.0.0/16
```
...
# 2.拉取镜像并打标签
docker pull docker.io/mirrorgooglecontainers/kube-apiserver-amd64:v1.17.4
docker tag docker.io/mirrorgooglecontainers/kube-apiserver-amd64:v1.17.4 k8s.gcr.io/kube-apiserver:v1.17.4

docker pull docker.io/mirrorgooglecontainers/kube-controller-manager-amd64:vv1.17.4
docker tag docker.io/mirrorgooglecontainers/kube-controller-manager-amd64:v1.17.4 k8s.gcr.io/kube-controller-manager:v1.17.4

docker pull docker.io/mirrorgooglecontainers/kube-scheduler-amd64:v1.17.4
docker tag docker.io/mirrorgooglecontainers/kube-scheduler-amd64:v1.17.4 k8s.gcr.io/kube-scheduler:v1.17.4

docker pull docker.io/mirrorgooglecontainers/kube-proxy-amd64:v1.17.4
docker tag docker.io/mirrorgooglecontainers/kube-proxy-amd64:v1.17.4 k8s.gcr.io/kube-proxy:v1.17.4

docker pull docker.io/mirrorgooglecontainers/pause-amd64:3.4
docker tag docker.io/mirrorgooglecontainers/pause-amd64:3.4 k8s.gcr.io/pause:3.4

docker pull docker.io/mirrorgooglecontainers/etcd-amd64:3.4.3-0
docker tag docker.io/mirrorgooglecontainers/etcd-amd64:3.4.3-0 k8s.gcr.io/etcd:3.4.3-0
...
kubectl delete ns istio-system --grace-period=0 --force
 ...
 # 1.1.参数 
--grace-period=0 --force--grace-period=0 --force

# 2.正常操作

# 2.1.先删除deployment,pod,svc再删除namespace

# 指令
kubectl delete pods PODNAME -n istio-system --grace-period=0 --force
