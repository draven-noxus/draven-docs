...
```shell
# prometheus-server 相关
# https://prometheus.io/
# https://prometheus.io/download/
# https://prometheus.io/dosc/instrumenting/exporters
# 
...
curl -O https://dl.grafana.com/oss/release/grafana-7.3.1.darwin-amd64.tar.gz

tar -zxvf grafana-7.3.1.darwin-amd64.tar.gz
```
...
```ini
# 参考文档 https://grafana.com/docs/grafana/latest/administration/configuration/
