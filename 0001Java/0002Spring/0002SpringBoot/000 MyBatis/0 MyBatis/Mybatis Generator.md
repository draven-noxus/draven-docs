...
```java
package com.resoft.infodisc.common.config;
...
<!--     <jdbcConnection driverClass="com.mysql.jdbc.Driver"
    ...
    <javaModelGenerator targetPackage="com.resoft.infodisc.bondinfo.entity" targetProject=".\src">
    ...
    <sqlMapGenerator targetPackage="com.resoft.infodisc.bondinfo.mappings"  targetProject=".\src">
		<!-- enableSubPackages:是否让schema作为包的后缀 -->
		<property name="enableSubPackages" value="false" />
    </sqlMapGenerator>
...
<!-- 		<property name="enableSubPackages" value="false" />
	...
	<table schema="" tableName="T_CLN_BOND_INFO"></table>
